...
fn complete_code() {
    ...
    let generated_tokens = tokens.clone();
    let exp_tokens = &[
        Token {
            token_type: TokenType::Let,
            content: "let".to_owned(),
    ...
    let mut f_generated_tokens = File::create("generated_tokens.txt").unwrap();
    let mut f_expected_tokens = File::create("expected_tokens.txt").unwrap();

    write!(&mut f_generated_tokens, "{:#?}\n", generated_tokens).unwrap();
    write!(&mut f_expected_tokens, "{:#?}\n", exp_tokens).unwrap();
